const DEFAULT_URL = 'https://justcors.com/tl_9580d3d/http://exam-2023-1-api.std-900.ist.mospolytech.ru/api';
const API_KEY = '5a3d049d-383f-426d-9b1f-c3064552a293';
const GEOCODE_URL = 'https://catalog.api.2gis.com/3.0/items/geocode';
const API_KEY_2GIS = '64478e91-ae1d-4b5c-a5d9-b6d0449997d1';
const PER_PAGE = 10;
...
function changeFieldRequestHandler(event) {
    ...
    if (excursionDate.value != '' && startTime.value != '') {
        ...
        if (option1.checked) calculateTotalCost *= 0.85;
...
async function buttonChooseGuideHandler(event) {
    ...
    option1Desc.innerHTML = 'скидка для школьников и студентов стоимость уменьшается на ';
